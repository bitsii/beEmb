...
//#define BESPEC_SW "0.NodeMcuLeds.25"  //nodemcu
//#define BESPEC_SW  "0.DollaLed.20" //dollatek 2mb 1led
//#define BESPEC_SW "0.AthomPlugV2.29" //Athom Plug V2 US THE REAL ONE
#define BESPEC_SW "0.NodeAthswy.27"  //nodemcu like athsw
//
