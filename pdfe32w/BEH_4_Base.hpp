#define BEAR_ESP32
#define BEDCC_SGC
#define BEQP(variable_name) beq->variable_name
#define BECC_HS
...
#define BESPEC_SW "1,q,df,t3,p6,p2.rGateDf.693"  //nodemcu df,t3
...
virtual BEC_2_6_6_SystemObject* bem_print_1(BEC_2_6_6_SystemObject* bevk_athing);
...
virtual BEC_2_8_3_EmbeddedApp* bem_digitalWriteHigh_1(BEC_2_4_3_MathInt* bevk_pin);
virtual BEC_2_8_3_EmbeddedApp* bem_digitalWriteLow_1(BEC_2_4_3_MathInt* bevk_pin);
...
BEC_2_9_4_ContainerList* bevp_changes = nullptr;
BEC_2_4_6_TextString* bevp_bedn = nullptr;
BEC_2_4_6_TextString* bevp_bedv = nullptr;
BEC_2_4_6_TextString* bevp_bedmax = nullptr;
BEC_2_4_3_MathInt* bevp_lastBmx = nullptr;
virtual BEC_2_6_6_SystemObject* bem_new_0();
...
virtual BEC_2_8_4_EmbeddedMdns* bem_new_4(BEC_2_4_6_TextString* bevk__name, BEC_2_4_6_TextString* bevk__service, BEC_2_4_3_MathInt* bevk__port, BEC_2_4_6_TextString* bevk__protocol);
virtual BEC_2_8_4_EmbeddedMdns* bem_start_0();
virtual BEC_2_4_6_TextString* bem_getAddr_1(BEC_2_4_6_TextString* bevk_tqname);
...
class BET_2_8_3_EmbeddedTds : public BETS_Object {
public:
BET_2_8_3_EmbeddedTds();
virtual BEC_2_6_6_SystemObject* bems_createInstance();
virtual void bemgt_doMark();
static BEC_2_6_6_SystemObject** bevs_inst_ref;
};
class BEC_2_8_3_EmbeddedTds : public BEC_2_6_6_SystemObject {
private:
typedef BEC_2_6_6_SystemObject bevs_super;

public:
BEC_2_4_6_TextString* bevp_amc = nullptr;
BEC_2_4_6_TextString* bevp_wac = nullptr;
BEC_2_4_6_TextString* bevp_mySay = nullptr;
BEC_2_4_6_TextString* bevp_myWants = nullptr;
BEC_2_8_8_EmbeddedAppShell* bevp_ash = nullptr;
BEC_2_4_6_TextString* bevp_waits = nullptr;
BEC_2_4_6_TextString* bevp_waitsRip = nullptr;
BEC_2_4_6_TextString* bevp_gots = nullptr;
BEC_2_4_6_TextString* bevp_gotsRip = nullptr;
BEC_2_4_6_TextString* bevp_sayMy = nullptr;
BEC_2_4_6_TextString* bevp_sayWants = nullptr;
BEC_2_6_6_SystemObject* bevp_callback = nullptr;
virtual BEC_2_8_3_EmbeddedTds* bem_new_2(BEC_2_4_6_TextString* bevk__myName, BEC_2_6_6_SystemObject* bevk__ash);
virtual BEC_2_8_3_EmbeddedTds* bem_say_1(BEC_2_4_6_TextString* bevk_toSay);
virtual BEC_2_8_3_EmbeddedTds* bem_startListen_0();
virtual BEC_2_8_3_EmbeddedTds* bem_start_0();
virtual BEC_2_8_3_EmbeddedTds* bem_update_0();
virtual BEC_2_4_6_TextString* bem_mdnsGet_1(BEC_2_6_6_SystemObject* bevk_wnm);
virtual BEC_2_8_3_EmbeddedTds* bem_sayWants_1(BEC_2_4_6_TextString* bevk_wants);
virtual BEC_2_4_6_TextString* bem_getAddr_1(BEC_2_4_6_TextString* bevk_name);
virtual BEC_2_4_6_TextString* bem_getAddrDis_1(BEC_2_4_6_TextString* bevk_name);
virtual BEC_2_6_6_SystemObject* bem_callbackGet_0();
virtual BEC_2_8_3_EmbeddedTds* bem_callbackSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_6_6_SystemObject* bemc_create();
static BEC_2_8_3_EmbeddedTds* bece_BEC_2_8_3_EmbeddedTds_bevs_inst;
virtual void bemc_setInitial(BEC_2_6_6_SystemObject* becc_inst);
virtual BEC_2_6_6_SystemObject* bemc_getInitial();
virtual void bemg_doMark();
virtual size_t bemg_getSize();
virtual ~BEC_2_8_3_EmbeddedTds() = default;
...
virtual BEC_2_6_6_SystemObject* bemd_1(int32_t callId, BEC_2_6_6_SystemObject* bevd_0);
virtual BEC_2_6_6_SystemObject* bemd_2(int32_t callId, BEC_2_6_6_SystemObject* bevd_0, BEC_2_6_6_SystemObject* bevd_1);
static BET_2_8_3_EmbeddedTds bece_BEC_2_8_3_EmbeddedTds_bevs_type;
};

class BET_2_8_4_EmbeddedDfis : public BETS_Object {
public:
BET_2_8_4_EmbeddedDfis();
virtual BEC_2_6_6_SystemObject* bems_createInstance();
virtual void bemgt_doMark();
static BEC_2_6_6_SystemObject** bevs_inst_ref;
};
class BEC_2_8_4_EmbeddedDfis : public BEC_2_6_6_SystemObject {
private:
typedef BEC_2_6_6_SystemObject bevs_super;

public:
BEC_2_8_8_EmbeddedAppShell* bevp_ash = nullptr;
BEC_2_4_3_MathInt* bevp_nextOutset = nullptr;
BEC_2_4_3_MathInt* bevp_nextWifiDis = nullptr;
BEC_2_9_4_ContainerList* bevp_ocmdl = nullptr;
...
BEC_2_4_6_TextString* bevp_status = nullptr;
virtual BEC_2_8_4_EmbeddedDfis* bem_new_1(BEC_2_6_6_SystemObject* bevk__ash);
virtual BEC_2_8_4_EmbeddedDfis* bem_start_0();
virtual BEC_2_8_4_EmbeddedDfis* bem_handleLoop_0();
virtual BEC_2_4_6_TextString* bem_handleCmdl_1(BEC_2_9_4_ContainerList* bevk_cmdl);
virtual BEC_2_4_6_TextString* bem_sendCmd_2(BEC_2_4_6_TextString* bevk_rip, BEC_2_4_6_TextString* bevk_scmds);
virtual BEC_2_6_6_SystemObject* bemc_create();
static BEC_2_8_4_EmbeddedDfis* bece_BEC_2_8_4_EmbeddedDfis_bevs_inst;
virtual void bemc_setInitial(BEC_2_6_6_SystemObject* becc_inst);
virtual BEC_2_6_6_SystemObject* bemc_getInitial();
virtual void bemg_doMark();
virtual size_t bemg_getSize();
virtual ~BEC_2_8_4_EmbeddedDfis() = default;
virtual BEC_2_6_6_SystemObject* bemd_0(int32_t callId);
virtual BEC_2_6_6_SystemObject* bemd_1(int32_t callId, BEC_2_6_6_SystemObject* bevd_0);
virtual BEC_2_6_6_SystemObject* bemd_2(int32_t callId, BEC_2_6_6_SystemObject* bevd_0, BEC_2_6_6_SystemObject* bevd_1);
static BET_2_8_4_EmbeddedDfis bece_BEC_2_8_4_EmbeddedDfis_bevs_type;
};

class BET_2_8_3_EmbeddedBLE : public BETS_Object {
public:
BET_2_8_3_EmbeddedBLE();
virtual BEC_2_6_6_SystemObject* bems_createInstance();
virtual void bemgt_doMark();
static BEC_2_6_6_SystemObject** bevs_inst_ref;
};
class BEC_2_8_3_EmbeddedBLE : public BEC_2_6_6_SystemObject {
private:
typedef BEC_2_6_6_SystemObject bevs_super;

public:
BEC_2_4_6_TextString* bevp_finssidp = nullptr;
virtual BEC_2_8_3_EmbeddedBLE* bem_new_1(BEC_2_4_6_TextString* bevk__finssidp);
virtual BEC_2_8_3_EmbeddedBLE* bem_default_0();
virtual BEC_2_8_3_EmbeddedBLE* bem_start_0();
virtual BEC_2_8_3_EmbeddedBLE* bem_write_1(BEC_2_4_6_TextString* bevk_line);
virtual BEC_2_4_6_TextString* bem_checkGetPayload_2(BEC_2_4_6_TextString* bevk_payload, BEC_2_4_6_TextString* bevk_endmark);
virtual BEC_2_5_4_LogicBool* bem_availableGet_0();
virtual BEC_2_6_6_SystemObject* bemc_create();
static BEC_2_8_3_EmbeddedBLE* bece_BEC_2_8_3_EmbeddedBLE_bevs_inst;
virtual void bemc_setInitial(BEC_2_6_6_SystemObject* becc_inst);
virtual BEC_2_6_6_SystemObject* bemc_getInitial();
virtual void bemg_doMark();
virtual size_t bemg_getSize();
virtual BETS_Object* bemc_getType();
virtual ~BEC_2_8_3_EmbeddedBLE() = default;
virtual BEC_2_6_6_SystemObject* bemd_0(int32_t callId);
virtual BEC_2_6_6_SystemObject* bemd_1(int32_t callId, BEC_2_6_6_SystemObject* bevd_0);
virtual BEC_2_6_6_SystemObject* bemd_2(int32_t callId, BEC_2_6_6_SystemObject* bevd_0, BEC_2_6_6_SystemObject* bevd_1);
static BET_2_8_3_EmbeddedBLE bece_BEC_2_8_3_EmbeddedBLE_bevs_type;
};
...
BEC_2_4_3_MathInt* bevp_nextUfuCheck = nullptr;
virtual BEC_2_8_6_EmbeddedUpdate* bem_new_1(BEC_2_6_6_SystemObject* bevk__ash);
virtual BEC_2_8_6_EmbeddedUpdate* bem_handleLoop_0();
virtual BEC_2_8_6_EmbeddedUpdate* bem_updateFromUrl_1(BEC_2_4_6_TextString* bevk_url);
virtual BEC_2_4_6_TextString* bem_supurlGet_0();
virtual BEC_2_8_6_EmbeddedUpdate* bem_supurlSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_3_MathInt* bem_nextUfuCheckGet_0();
virtual BEC_2_8_6_EmbeddedUpdate* bem_nextUfuCheckSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_6_6_SystemObject* bemc_create();
...
class BET_2_8_11_EmbeddedCommonNames : public BETS_Object {
public:
BET_2_8_11_EmbeddedCommonNames();
virtual BEC_2_6_6_SystemObject* bems_createInstance();
virtual void bemgt_doMark();
static BEC_2_6_6_SystemObject** bevs_inst_ref;
};
class BEC_2_8_11_EmbeddedCommonNames : public BEC_2_6_6_SystemObject {
private:
typedef BEC_2_6_6_SystemObject bevs_super;
...
BEC_2_4_6_TextString* bevp_fail = nullptr;
BEC_2_4_6_TextString* bevp_undefined = nullptr;
virtual BEC_2_8_11_EmbeddedCommonNames* bem_default_0();
virtual BEC_2_4_6_TextString* bem_onGet_0();
virtual BEC_2_8_11_EmbeddedCommonNames* bem_onSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_offGet_0();
virtual BEC_2_8_11_EmbeddedCommonNames* bem_offSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_okGet_0();
virtual BEC_2_8_11_EmbeddedCommonNames* bem_okSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_failGet_0();
virtual BEC_2_8_11_EmbeddedCommonNames* bem_failSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_undefinedGet_0();
virtual BEC_2_8_11_EmbeddedCommonNames* bem_undefinedSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_6_6_SystemObject* bemc_create();
static BEC_2_8_11_EmbeddedCommonNames* bece_BEC_2_8_11_EmbeddedCommonNames_bevs_inst;
virtual void bemc_setInitial(BEC_2_6_6_SystemObject* becc_inst);
virtual BEC_2_6_6_SystemObject* bemc_getInitial();
virtual void bemg_doMark();
virtual size_t bemg_getSize();
virtual BETS_Object* bemc_getType();
virtual ~BEC_2_8_11_EmbeddedCommonNames() = default;
virtual BEC_2_6_6_SystemObject* bemd_0(int32_t callId);
virtual BEC_2_6_6_SystemObject* bemd_1(int32_t callId, BEC_2_6_6_SystemObject* bevd_0);
static BET_2_8_11_EmbeddedCommonNames bece_BEC_2_8_11_EmbeddedCommonNames_bevs_type;
};
...
BEC_2_9_4_ContainerList* bevp_sxd = nullptr;
BEC_2_9_4_ContainerList* bevp_sxdi = nullptr;
...
BEC_2_4_3_MathInt* bevp_shpowi = nullptr;
BEC_2_4_3_MathInt* bevp_zero = nullptr;
BEC_2_4_3_MathInt* bevp_nextSwSpec = nullptr;
BEC_2_4_3_MathInt* bevp_nextRestart = nullptr;
BEC_2_4_3_MathInt* bevp_nextMaybeSave = nullptr;
BEC_2_4_3_MathInt* bevp_nextPow = nullptr;
BEC_2_4_3_MathInt* bevp_endResetByPow = nullptr;
BEC_2_4_6_TextString* bevp_slashn = nullptr;
BEC_2_4_6_TextString* bevp_slashr = nullptr;
BEC_2_5_4_LogicBool* bevp_needsRestart = nullptr;
BEC_2_5_4_LogicBool* bevp_justSetWifi = nullptr;
BEC_2_5_4_LogicBool* bevp_pastSetupTime = nullptr;
BEC_2_4_6_TextString* bevp_did = nullptr;
BEC_2_4_6_TextString* bevp_devCode = nullptr;
BEC_2_5_4_LogicBool* bevp_resetByPow = nullptr;
BEC_2_5_4_LogicBool* bevp_inResetByPow = nullptr;
BEC_2_4_6_TextString* bevp_readBuf = nullptr;
BEC_2_4_6_TextString* bevp_controlSpec = nullptr;
BEC_2_4_6_TextString* bevp_controlDef = nullptr;
BEC_2_4_3_MathInt* bevp_controlHash = nullptr;
...
BEC_2_4_3_MathInt* bevp_drift = nullptr;
BEC_2_4_3_MathInt* bevp_secCount = nullptr;
BEC_2_4_3_MathInt* bevp_upCount = nullptr;
BEC_2_4_3_MathInt* bevp_one = nullptr;
BEC_2_4_3_MathInt* bevp_onek = nullptr;
BEC_2_4_3_MathInt* bevp_oneh = nullptr;
BEC_2_4_6_TextString* bevp_pin = nullptr;
BEC_2_4_6_TextString* bevp_myName = nullptr;
BEC_2_4_6_TextString* bevp_pass = nullptr;
BEC_2_4_6_TextString* bevp_spass = nullptr;
BEC_2_4_6_TextString* bevp_secQ = nullptr;
BEC_2_8_9_EmbeddedSerServer* bevp_serserver = nullptr;
BEC_2_8_4_EmbeddedMdns* bevp_mdserver = nullptr;
BEC_2_8_3_EmbeddedTds* bevp_tdserver = nullptr;
BEC_2_8_4_EmbeddedDfis* bevp_dfserver = nullptr;
BEC_2_8_9_EmbeddedTCPServer* bevp_tcpserver = nullptr;
BEC_2_8_6_EmbeddedUpdate* bevp_eupd = nullptr;
BEC_2_8_3_EmbeddedBLE* bevp_blesup = nullptr;
BEC_2_4_6_TextString* bevp_apSsid = nullptr;
BEC_2_4_6_TextString* bevp_apType = nullptr;
BEC_2_4_6_TextString* bevp_hiddenCode = nullptr;
BEC_2_4_6_TextString* bevp_ssid = nullptr;
BEC_2_4_6_TextString* bevp_sec = nullptr;
BEC_2_4_3_MathInt* bevp_lsec = nullptr;
BEC_2_9_4_ContainerList* bevp_ivs = nullptr;
BEC_2_4_3_MathInt* bevp_ivpt = nullptr;
BEC_2_9_4_ContainerList* bevp_visnets = nullptr;
...
virtual BEC_2_4_6_TextString* bem_doState_2(BEC_2_4_3_MathInt* bevk_ctlPos, BEC_2_9_4_ContainerList* bevk_cmdl);
...
virtual BEC_2_8_8_EmbeddedAppShell* bem_makeSecQ_0();
...
virtual BEC_2_8_8_EmbeddedAppShell* bem_genControlDef_0();
...
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartUpServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartTdServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartSmcServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartMatrServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartEhServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartDfServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartTaServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkStartHbServer_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkWifiAp_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_startBleSup_1(BEC_2_4_6_TextString* bevk_finssidp);
virtual BEC_2_8_8_EmbeddedAppShell* bem_initSetup_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_startWifi_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_checkWifiUp_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_initPow_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_clearPow_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_handleLoop_0();
virtual BEC_2_4_6_TextString* bem_doCmd_2(BEC_2_4_6_TextString* bevk_channel, BEC_2_4_6_TextString* bevk_cmdline);
virtual BEC_2_4_6_TextString* bem_hashIt_1(BEC_2_4_6_TextString* bevk_it);
virtual BEC_2_4_6_TextString* bem_doCmdlSec_2(BEC_2_4_6_TextString* bevk_channel, BEC_2_9_4_ContainerList* bevk_cmdl);
virtual BEC_2_4_6_TextString* bem_secTime_3(BEC_2_4_6_TextString* bevk_iv, BEC_2_4_6_TextString* bevk_hdone, BEC_2_4_6_TextString* bevk_tesh);
virtual BEC_2_4_6_TextString* bem_getvisnets_2(BEC_2_9_4_ContainerList* bevk_cmdl, BEC_2_4_3_MathInt* bevk_curpos);
virtual BEC_2_4_6_TextString* bem_doCmdl_2(BEC_2_4_6_TextString* bevk_channel, BEC_2_9_4_ContainerList* bevk_cmdl);
...
virtual BEC_2_9_4_ContainerList* bem_sxdGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_sxdSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_9_4_ContainerList* bem_sxdiGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_sxdiSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_5_4_LogicBool* bem_needsFsRestartGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_needsFsRestartSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_swSpecGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_swSpecSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_5_4_LogicBool* bem_needsGcGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_needsGcSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_3_MathInt* bem_nextWifiCheckGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_nextWifiCheckSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_myNameGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_myNameSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
...
virtual BEC_2_8_3_EmbeddedTds* bem_tdserverGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_tdserverSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_ssidGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_ssidSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_4_6_TextString* bem_secGet_0();
virtual BEC_2_8_8_EmbeddedAppShell* bem_secSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
virtual BEC_2_6_6_SystemObject* bemc_create();
...
virtual BEC_2_4_3_MathInt* bem_squaredGet_0();
virtual BEC_2_4_3_MathInt* bem_squareRootGet_0();
...
virtual BEC_2_4_6_TextString* bem_lengthSet_1(BEC_2_6_6_SystemObject* bevt_0_ta_SET);
...
virtual BEC_2_4_6_TextString* bem_toAlphaNumSpace_1(BEC_2_4_6_TextString* bevk_toCheck);
virtual BEC_2_4_3_MathInt* bem_zeroGet_0();
...
virtual BEC_2_6_6_SystemObject* bem_remove_1(BEC_2_4_3_MathInt* bevk_pos);
virtual BEC_2_6_6_SystemObject* bem_iteratorGet_0();
...
virtual BEC_2_4_6_TextString* bem_getString_1(BEC_2_4_3_MathInt* bevk_length);
virtual BEC_2_4_6_TextString* bem_getString_2(BEC_2_4_6_TextString* bevk_str, BEC_2_4_3_MathInt* bevk_length);
virtual BEC_2_6_6_SystemObject* bemc_create();
...
class BET_2_8_4_EmbeddedNada : public BETS_Object {
public:
BET_2_8_4_EmbeddedNada();
virtual BEC_2_6_6_SystemObject* bems_createInstance();
virtual void bemgt_doMark();
static BEC_2_6_6_SystemObject** bevs_inst_ref;
};
class BEC_2_8_4_EmbeddedNada : public BEC_2_8_8_EmbeddedAppShell {
private:
...
virtual BEC_2_6_6_SystemObject* bem_buildControl_3(BEC_2_4_3_MathInt* bevk_conPos, BEC_2_4_6_TextString* bevk_conName, BEC_2_4_6_TextString* bevk_conArgs);
virtual BEC_2_6_6_SystemObject* bemc_create();
static BEC_2_8_4_EmbeddedNada* bece_BEC_2_8_4_EmbeddedNada_bevs_inst;
virtual void bemc_setInitial(BEC_2_6_6_SystemObject* becc_inst);
virtual BEC_2_6_6_SystemObject* bemc_getInitial();
virtual void bemg_doMark();
virtual size_t bemg_getSize();
virtual ~BEC_2_8_4_EmbeddedNada() = default;
virtual BEC_2_6_6_SystemObject* bemd_3(int32_t callId, BEC_2_6_6_SystemObject* bevd_0, BEC_2_6_6_SystemObject* bevd_1, BEC_2_6_6_SystemObject* bevd_2);
static BET_2_8_4_EmbeddedNada bece_BEC_2_8_4_EmbeddedNada_bevs_type;
};
