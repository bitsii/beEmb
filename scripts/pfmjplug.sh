...
echo "Profile for the Martin Jerry Round Plug.  Button toggles the switch on +30ms hold and resets device on +30s hold. Serial input disabled. Not updatable after initial firmware load." > $APPBLDNM/README.txt
