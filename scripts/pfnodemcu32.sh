...
echo "Profile for a Esp32 NodeMCU with a switch control on built in LED pin 16 and a dimmer control on built in LED pin 2 with most controls.  Serial input enabled." > $APPBLDNM/README.txt
