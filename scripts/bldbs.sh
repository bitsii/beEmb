...
java -XX:-UsePerfData -XX:TieredStopAtLevel=1 -XX:+UseSerialGC be.BEL_Base -deployPath=targets/ard -buildPath=targets/ard --buildFile build/bsBase.txt --emitLang cc --singleCC true --emitFlag ccSgc --emitFlag ccNoRtti --emitFlag relocMain --emitFlag holdMain --emitFlag embPlat --emitFlag noSmap --emitFlag noRfl -cchImport=../braceEmb/system/cc/be/BEBS_Imports.hpp -ccImport=../braceEmb/system/cc/be/BEBS_Imports.cpp --mainClass Embedded:BootStrapApp ../brace/source/base/Uses.be source/ArdEmb.be source/ArdTcp.be source/BS.be
