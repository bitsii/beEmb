...
./scripts/bldesp8266.sh --mainClass Embedded:Grande source/SC.be source/DC.be source/RDC.be source/RGDC.be source/BC.be source/RGBC.be source/RGBGDC.be source/StrC.be source/Grande.be
