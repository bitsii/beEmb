...
./scripts/bldesp8266.sh --mainClass Embedded:Grande source/SC.be source/DC.be source/BC.be source/RGBC.be source/CCTC.be source/ESC.be source/StrC.be source/Grande.be
