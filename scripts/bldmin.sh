...
java -XX:-UsePerfData -XX:TieredStopAtLevel=1 -XX:+UseSerialGC be.BEL_Base -deployPath=targets/min -buildPath=targets/min --buildFile build/embBase.txt --emitLang cc --singleCC true --emitFlag ccSgc --mainClass Test:TestHelloWorld ../brace/source/baseTest/TestHelloWorld.be
