...
//
#define BESPEC_SW "1,q,p4,p2.rAthBlb7w.64"  //generic configurable controls Athlb017w LB01-7W-B22
//
...
#define BESPEC_CON "0.rgbcwgd.4,12,14,5,13" //all in one, pins cold, warm, red, green, blue, gammadim, exclusive cw or
