...
//
#define BESPEC_SW "1,q,p6,p2.rAthBlb15w.121"  //generic configurable controls Athlb017w LB01-7W-B22
// UPD
//#define BE_UPDBASE "na"  //if we don't have one.  otherwise, the url base for the update ver txt file and binfiles
#define BE_UPDBASE "https://storage.googleapis.com/casnicdl.casnic.net/pfathlb0115w.ino.generic"
//
