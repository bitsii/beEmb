...
//
#define BESPEC_SW "1,q,p6,p2.Bulb.168"  //template for rgb cold warm bulb df,
//
// UPD
...
#define BESPEC_CON "0.rgbcwgd.6,7,5,4,3" //all in one, red, green, blue, (cold) white, (warm) white
