...
//
#define BESPEC_SW "1,q,p6,p2.Rgbcw.132"
//
// rgbcwgd is for bulbs where the cold and warm are independent led's and the temp is controlled by
// their relative levels
#define BESPEC_CON "0.rgbcwgd.4,12,14,5,13" //4,12,14 are r,g,b, 5 is (cold) white, 13 (warm) white
//#define BESPEC_CON "0.rgbcwgd.12,14,5,4,13" //12,14,5 are r,g,b, 4 is (cold) white, 13 (warm) white
//
// rgbcwsgd is for bulbs where one of the two cw pins determines overall dim level and the other determines
// temp
//#define BESPEC_CON "0.rgbcwsgd.4,12,14,5,13" //4,12,14 are r,g,b 5 is white level 13 is temp
//
