...
#define BESPEC_SW "1,q,nm,a1,t3,p6,p2.rMatrC6N8.114"  //nodemcu q = quickstate, p2 auth type 2 (hash), p2 always last
...
#define BE_UPDBASE "http://storage.googleapis.com/casnicdl.casnic.net/pfmatrc6n8.ino.esp32c6"
//
