...
#define BESPEC_SW "1,q,nm,a1,t3,p6,p2.rMatrEw.120"  //nodemcu q = quickstate, p2 auth type 2 (hash), p2 always last
...
//#define BE_UPDBASE "http://storage.googleapis.com/casnicdl.casnic.net/pfmatre32w.ino.esp32"
//
