...
//
#define BESPEC_SW "1,q,p3,p2.AIYATOEH9W.50"  //generic configurable controls Athlb017w LB01-7W-B22
//
...
//W B R T G || C B R W G pin order (LB01-7W-B22) pins 4,5,12,13,14
//Just the R G B part now
#define BESPEC_CON "0.rgb.12,14,5" //
