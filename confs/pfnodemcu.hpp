...
#define BESPEC_SW "1,q,p3,p2.Nmcu.60"  //nodemcu q = quickstate, p2 auth type 2 (hash), p2 always last
...
#define BESPEC_CON "0.cctsgdim.5,13.rgbgdim.4,12,14.esc.0,1"  //full deck, cct and rgb with esc
