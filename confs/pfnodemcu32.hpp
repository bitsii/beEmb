...
#define BESPEC_SW "1,q,p6,p2.rNodeMCU32.77"  //nodemcu q = quickstate, p2 auth type 2 (hash), p2 always last
...
//#define BESPEC_CON "0.sw.8" //DevKitC-02 ESP32-C3-WROOM-02, doesn't work
